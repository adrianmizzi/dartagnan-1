module CodeGenContikiIotLab where
...
imports pp =
  ...
  "#include <stdbool.h>\n" ++
  "#include \"mycomms.c\"\n" ++
  "#include \"mysensorutils.c\"\n" ++ 
  "#include \"myutils.c\"\n" ++ 
  "#include \"myencoderdecoder.c\"\n" ++
...
addr = "\n" ++
  "static rimeaddr_t node1 = { { 1, 124 } }; // wsn430-5.grenoble\n" ++
  "static rimeaddr_t node2 = { { 1, 198 } }; // wsn430-6.grenoble\n" ++
  "static rimeaddr_t node3 = { { 1, 158 } }; // wsn430-7.grenoble\n" ++
  "static rimeaddr_t node4 = { { 1, 127 } }; // wsn430-8.grenoble\n" ++
  "static rimeaddr_t node5 = { { 1, 237 } }; // wsn430-10.grenoble\n" ++
  "static rimeaddr_t node6 = { { 1, 64 } }; // wsn430-11.grenoble\n" ++
  "static rimeaddr_t node7 = { { 1, 254 } }; // wsn430-12.grenoble\n"
  ...
  where
    master_code_only = if master 
                         then 
                           ...
                           "\n" ++
                           "  while (1) {\n" ++
                           "    // start main process every 5 seconds\n" ++
